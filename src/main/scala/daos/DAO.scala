...
trait DAO {
   ...
   * @param limit: maximum number of articles. Pass None (default) to get all articles from source. If source contains less
   * articles than limit, all available articles will be returned.
